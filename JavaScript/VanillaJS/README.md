...
<ol>
  <li>Проект называется: <a href="https://deokti.github.io/JavaScript/VanillaJS/NewsApp/V1/" target="_black">NewsApp (первая версия)</a>;</li>
...
<ol>
   <li>Проект называется: <a href="https://deokti.github.io/JavaScript/VanillaJS/NewsApp/V2/dist" target="_black">NewsApp (вторая версия)</a>;</li>
