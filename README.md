...
<ol>
 ...
 <li>В настоящее время потрачено 24 часа и 12 минут. В первый раз в жизни писал код на JavaScript. А если точнее jQuery. Стоит учитывать и то, в JavaScript совершенно ничего не знаю, из-за чего пришлось потратить много времени на поиски ответа в интернете. В конечном итоге он нашёлся, но пришлось читать свойства и переделывать полученный код. С трудом, но получилось. Сама вёрстка почти окончена. Единственное что осталось - сделать адаптив на последние несколько секций. С самыми сложными работа закончена, и по этой причине осталось делать совсем недолго. Тем не менее мне интересно как поведёт себя задний фон и с этим наверное будут проблемы;</li>
 <li>Макет был взят из телеграмм-канала, создателем которого является Артём Исламов, автор ютуб-канала Glo Academy: 
    <a href="https://www.youtube.com/channel/UCVswRUcKC-M35RzgPRv8qUg/featured">ссылка на YouTube-канал</a> и 
    <a href="https://t.me/glo_academy">ссылка на телеграмм-канал откуда взят макет;</a></li>
</ol>  
