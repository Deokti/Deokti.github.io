...
<ol>
  <li>Сайт называется <a href="https://deokti.github.io/Eddie's-Car/" target="blank">Eddie's-Car</a></li>
 	...
 	<li>Пока что сказать нечего. Вёрстка началась 13.10.2019; </li>
 <li>В настоящее время потрачено 16 часов и 46 минут. В первый раз в жизни писал код на JavaScript. А если точнее JQuerty. Стоит учитывать и то, в JavaScript совершенно ничего не знаю, из-за чего пришлось потратить много времени на поиски ответа в интернете. В конечном итоге он нашёлся, но пришлось читать свойства и переделывать полученный код. С трудом, но получилось. Сама вёрстка почти окончена. Единственное что осталось - сделать адаптив, и судя по всему с этим будет сложновато. С одной стороны делается относительно легко, в оеределённый момент нужно будет поменять расположеное с горизонтального вида на вертикальный. Тем не менее мне интересно как поведёт себя задний фон и с этим наверное будут проблемы;</li>
 <li>Макет был взят из телеграмм-канала, создателем которого является Артём Исламов, автор ютуб-канала Glo Academy: 
    <a href="https://www.youtube.com/channel/UCVswRUcKC-M35RzgPRv8qUg/featured">ссылка на YouTube-канал</a> и 
    <a href="https://t.me/glo_academy">ссылка на телеграмм-канал откуда взят макет;</a></li>
</ol>  
