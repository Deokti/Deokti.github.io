...
<ol>
  <li>Сайт называется <a href="https://deokti.github.io/ADVOGRAND/ target="_blank"">ADVOGRAND</a></li>
 	...
 	<li>На данный момент, как сказано ниже потрачено где-то 5 часов и 38 минут. В действительности, теперь благодаря некоторому опыту вёрстка идёт немного легче, нежели прошлая, и тем более, нежели позапрошлая. И хотя в настоящее время потрачено больше пяти часов, половина из этого времени ушла на придумывание эффекта кнопки, и создание самого эффекта, поскольку такое для меня впервые;</li>
 <li>Вёрстка началась 13.11.2019. На данный момент потрачено 5 часов и 38 минут;</li>
 <li>Макет был взят из телеграмм-канала, создателем которого является Артём Исламов, автор ютуб-канала Glo Academy: 
    <a href="https://www.youtube.com/channel/UCVswRUcKC-M35RzgPRv8qUg/featured">ссылка на YouTube-канал</a> и 
    <a href="https://t.me/glo_academy">ссылка на телеграмм-канал откуда взят макет;</a></li>
</ol>  
