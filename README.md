...
<ol>
 ...
 <li>В настоящее время потрачено 14 часов и 32 минуты. В первый раз в жизни писал код на JavaScript. А если точнее JQuerty. Очень долгое время не мог понять как подступиться и заставить секцию: "У вас остались вопросы?", в некоторос мысле "ожить". В конечном итоге всё получилось, с помощью добавления и убирания класса active при помощи вышеупомянутой технологии. Осталось доделать макет до конца, три секции, заполнить alt="" у картинок и сделать адаптив;</li>
 <li>Макет был взят из телеграмм-канала, создателем которого является Артём Исламов, автор ютуб-канала Glo Academy: 
    <a href="https://www.youtube.com/channel/UCVswRUcKC-M35RzgPRv8qUg/featured">ссылка на YouTube-канал</a> и 
    <a href="https://t.me/glo_academy">ссылка на телеграмм-канал откуда взят макет;</a></li>
</ol>  
