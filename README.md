...
<b>Начиная с 6-го макета структура вложенности немного изменилась. В папке с сделанным сайтом будут добавляться:</b>.
<ol>
  <li>Папка <b>src</b>, - в которой код и писаелся;</li>
  <li>Папка <b>dist</b>, - собственно, в неё складывалось всё написанное. Сайт запускается именно из неё;</li>
