...
function sliderForWorldMap() {
  $('.surf-container-dots').slick({
    ...
    slidesToScroll: 1,
    arrows: false,
    asNavFor: '.subtitle-slider-container, .surf-cards-items',
    focusOnSelect: true,
    autoplay: true,
    autoplaySpeed: 4000,
  });
  ...
  $('.surf-cards-items').slick({
    ...
    slidesToShow: 4,
    slidesToScroll: 1,
    asNavFor: 'surf-container-dots, .subtitle-slider-container',
  ...
  $('.subtitle-slider-container').slick({
    autoplay: true,
    autoplaySpeed: 4000,
    slidesToShow: 1,
    asNavFor: '.surf-container-dots, .surf-cards-items',
    fade: true,
    arrows: false,
  });
}
