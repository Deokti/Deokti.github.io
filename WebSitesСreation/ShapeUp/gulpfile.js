...
/* -------- JAVASCRIPT --------*/
gulp.task('concat', () => gulp.src(['./src/js/polyfills/polyfill.js', './src/js/libs/jquery-3.4.1.min.js', './src/js/libs/tiny-slider.js', './src/js/hamburger.js', './src/js/change-address-video.js'])
    .pipe(babel())
    .pipe(uglify())
    .pipe(concat({
        path: 'script.js'
