...
<p>Известные на текуший момент "технологии": HTML, CSS, методология БЭМ, препроцессоры SASS/SCSS, FlexBox, Gulp, начальный JavaScript.</p>
...
<ol>
  ...
  <li>В настоящее время потрачено 6 часов и 51 минута. <a href="https://wakatime.com/projects/SwedishBitter?start=2020-01-21&end=2020-01-27" target="_blank">WakaTime</a>;</li>
  <li>Макет был взят с ютуб-канала, создателем которого является Вадим Прокопчук, автор ютуб-канала От 0 до 1: 
    <a href="https://www.youtube.com/channel/UCE_w6FxGfRKH2fU76raVeog/videos">ссылка на YouTube-канал</a> и 
