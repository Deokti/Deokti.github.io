...
<ol>
  ...
  <li><a href="https://cloud.mail.ru/public/Soo3/4NSMa6eao" target="_blank">Ссылка на внешний вид макета</a>;</li>
...
<ol>
  ...
  <li><a href="https://cloud.mail.ru/public/4bhW/2JKYHTsEs" target="_blank">Ссылка на внешний вид макета</a>;</li>
...
<ol>
  ...
  <li>Ссылки на внешний вид макета: 
    <a href="https://cloud.mail.ru/public/2Cqz/m47HsnBJQ" target="_blank">полная версия</a>, 
    <a href="https://cloud.mail.ru/public/XPfP/2erq7fk9B" target="_blank">планшетная версия</a>, 
    <a href="https://cloud.mail.ru/public/4dEG/RGNF6pyQQ" target="_blank">мобильная версия</a>;</li>
...
<ol>
  ...
  <li>Ссылки на внешний вид макета: 
    <a href="https://cloud.mail.ru/public/5pKP/5NAMJUGhL" target="_blank">полная версия</a>;</li>
  <li>Десятый макет, который начал верстать (четыре в другой папке, WebDespute). Этот относительно простой макет специально был взят для того, чтобы потренироваться в написании кода при использовании препроцессора HMTL - PUG, поскольку ранее с ним не работал. Стиот сказать, что это сложновато. Впрочем, что вполне возможно, это из-за того, что работую с ним первый раз. Нельзя исключать тот вариант, что после вёрстки данного макета вся остальная вёрстка будет делаться с помощью PUG. А возможно и нет. Стоит также добавить, что этот макет был выбран не просто так, посколько в прошлом я пытался верстать его и потерпел сокрушительную неудачу, поскольку не смог сделать даже первый экран. Таким образом сейчас - это всего лишь небольшая попытка отомстить и наконце сверстать его. Вначале я делал PixelPerfect, впрочем большая часть сделана с такой техникой. Единственное исключение - это галерея, с которой я решил не слишком заморачиваться в виду того, что не трогал макет долгое время. Это значит, что снова допустил ошибку, которую вроде бы писал выше, которая заключается в том, чтобы не бросать макет надолго иначе его вёрстка может заняться и пойти на спад;</li>
  <li>Добавился препроцессор PUG и Babel для перегонки нового синтаксиса JavaScript в старый;</li>
  <li>Макет завершён. На его создание понадобилось, приблизительно от 15 до 18 часов. К сожалению предоставить время законченного прокте не могу, прошло слишком много времени, и данные были удалены <a href="https://wakatime.com/projects/SwedishBitter?start=2020-01-21&end=2020-01-27" target="_blank">WakaTime</a>;</li>
...
<h2>GoSurf</h2>
<ol>
  <li>Сайт называется: <a href="https://deokti.github.io/WebSitesСreation/GoSurf/dist/" target="_blank">GoSurf</a> </li>
  <li>Ссылки на внешний вид макета: 
    <a href="https://cloud.mail.ru/public/b5on/2g4hZ9BuB" target="_blank">полная версия</a>;</li>
  <li>Двенадцатый макет, который начал верстать. В настоящее время сказать по нему многого не могу, по той простой причине, что единственное что сейчас может вылететь изо рта – это слова по типу: «Интересно, ничего не понятно, запутанно, боюсь ошибиться из-за чего придётся всё переделывать». Последнее, кстати говоря со мной и произошло, поскольку первоначальная вёрстка была не слишком пригодной для слайдера. Нужно было связать три элемента вместе: переключение названия места, переключение дороги на карте и переключение линии меняя ей цвет. Добиться этого можно было, по правде сказать не знаю, как, из-за чего пришлось переделывать некоторые моменты и попасть в ещё более худшую ситуацию – когда первоначальный вариант всё-таки оказался правильным, а второй и последующие нет. В итоге говоря, связать три элемента я решил с помощью дата атрибута. Карте, линии и локации дал одинаковые дата атрибуты и при нажатии на стрелочку вперёд или назад читать атрибут активного элемента и добавлять какой-то класс или менять на display: block у тех, чьи дата атрибуты идентичны. В итоге этот эффект всё-таки получился;</li>
  <li>PUG мне не очень приглянулся, более нравится работать с чистым html, хотя с моей точки зрения – это всего лишь привычка. В будущем попробую сверстать ещё один макет с использованием PUG, но посложнее предыдущего;</li>
  <li>Начал верстать макет, в настоящее время потрачено 11 часов и 41 минута, <a href="https://wakatime.com/projects/GoSurf?start=2020-05-25&end=2020-05-31" target="_blank">WakaTime</a>;</li>
  <li>Макет был взят с ютуб-канала, создателем которого является Вадим Прокопчук, автор ютуб-канала От 0 до 1: 
    <a href="https://www.youtube.com/channel/UCE_w6FxGfRKH2fU76raVeog/videos">ссылка на YouTube-канал</a> и 
    <a href="https://www.youtube.com/watch?v=TisGtkOPh24">ссылка на видео в котором макет;</a>;</li>
<ol>
